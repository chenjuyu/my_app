...
typedef ValueChanged2<T> =void Function(T value);
class SegControl extends StatefulWidget {
  ...
  final ValueChanged2 <int> doubleTap; //这里获取键位主可以了
  ...
  SegControl({
    ...
    this.doubleTap,//用于多次点的
  });

  _SegControlState state;

  @override
  _SegControlState createState() {
    state = _SegControlState();
    return state;
  }
}

class _SegControlState extends State<SegControl> with SingleTickerProviderStateMixin {
  TabController _ctrl;
