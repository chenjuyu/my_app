...
class _ProductDetailPageState extends State<ProductDetailPage> {
  ...
  List colorList = [
    ...
    },
    {
      ...
      {'GoodsID':'OOAC','Code':'9LA119M310',
        'Name':'测试货号','ColorID':'00D',"Color": "黄色", "type": 3,'tipqty':0},
    {'GoodsID':'OOAC','Code':'9LA119M310',
      'Name':'测试货号','ColorID':'00E',"Color": "绿色", "type": 4,'tipqty':0},
    {'GoodsID':'OOAC','Code':'9LA119M310',
      'Name':'测试货号','ColorID':'00F',"Color": "青色", "type": 5,'tipqty':0},
    {'GoodsID':'OOAC','Code':'9LA119M310',
      'Name':'测试货号','ColorID':'00G',"Color": "蓝色", "type": 6,'tipqty':0},
    {'GoodsID':'OOAC','Code':'9LA119M310',
      'Name':'测试货号','ColorID':'00H',"Color": "紫色", "type": 7,'tipqty':0},
    {'GoodsID':'OOAC','Code':'9LA119M310',
      'Name':'测试货号','ColorID':'00I',"Color": "红白色", "type": 8,'tipqty':0},
    {'GoodsID':'OOAC','Code':'9LA119M310',
      'Name':'测试货号','ColorID':'00J',"Color": "天蓝色", "type": 9,'tipqty':0},
    {'GoodsID':'OOAC','Code':'9LA119M310',
      'Name':'测试货号','ColorID':'00K',"Color": "蓝紫色", "type": 10,'tipqty':0},
  ];
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
            ...
            children: <Widget>[
              InkWell(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      Icon(
                          Icons.shopping_cart, size: 25.0, color: Colors.black26),
              ...
              Positioned(
                  ...
                  Container(
                    ...
                    child: Text('${cartQuantityTotal}',style: TextStyle(color: Colors.white,fontSize: 8.0),),
                  )
                      : Text('')
              ),
            ],
          ...
          InkWell(
            onTap: () {
              choseSizeList = sizeList.where((item) => item['ColorID'] ==
                  colorList[groupValue]['ColorID']).toList();
  ...
  getProviderData(context1, haveData) async {
    ...
    print('本地持久化中的数据:${await Provider
        .of<CartProvider>(context1)
        .cartInfo}');
  }
